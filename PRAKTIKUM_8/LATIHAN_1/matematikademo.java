...
public class matematikademo
{
    public static void main(String[] args) {
        ...
        mtk.pertambahandouble(12.5, 28.7, 14.2));
        ...
        System.out.println(" pertambahan : "+
        nf.format(mtk.pertambahandouble(angka1,angka2,angka3)));
        
        System.out.println(" pengurangan : "+
        nf.format(mtk.pengurangandouble(angka1,angka2,angka3)));

        System.out.println(" perkalian : "+
        nf.format(mtk.perkaliandouble(angka1,angka2,angka3)));

        System.out.println(" pembagian : "+
        nf.format(mtk.pembagiandouble(angka1,angka2,angka3)));
