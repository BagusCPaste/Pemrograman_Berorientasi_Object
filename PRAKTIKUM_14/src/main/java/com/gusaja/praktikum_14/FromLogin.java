...
public class FromLogin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        rsUser = stm.executeQuery("SELECT COUNT(*) FROM user WHERE user_id = '" + jTextField1.getText() + "' AND password = MD5('" + password + "')");
        int baris = 0;
        while (rsUser.next()) {
            baris = rsUser.getRow();
        }
        if (baris == 1) {
            ...
            JOptionPane.showMessageDialog(null, "User atau Password tidak Cocok -> " + jTextField1.getText() + " --> " + password);
        }
...
private void openDB() {
        try {
            ...
            String port = "3306";
            String database = "penjualan";
            String username = "root";
            String password = ""; // Ganti dengan kata sandi MySQL Anda
